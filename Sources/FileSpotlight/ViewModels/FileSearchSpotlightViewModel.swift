//
//  FileSearchSpotlightViewModel.swift
//  FileSpotlight
//
...
/// ```
@MainActor
public class FileSearchSpotlightViewModel<Item: SpotlightItem>: ObservableObject {
	...
	public init(
		...
		self.sections	   = [home as! Array<SpotlightSection<Item>>.ArrayLiteralElement]
